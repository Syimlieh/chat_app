...
const DisplayMessage = () => {
  return (
    <div className="w-full rounded-xl h-[calc(100vh_-_8rem)] bg-slate-50 p-8 mt-8 scroll-smooth scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch overflow-y-auto shadow-3xl">
      <div
        id="messages"
