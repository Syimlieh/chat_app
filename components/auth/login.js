              ...
              <form>
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-sm font-semibold mt-8 pt-1 mb-0 ">
                    ...
                    <button
                      className="bg-[#3b5998] px-7 py-3 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center"
                      onClick={() => signIn()}
                    >
                      <FcGoogle
                        style={{
